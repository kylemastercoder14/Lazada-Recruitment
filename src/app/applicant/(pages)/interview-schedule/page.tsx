          ...
          {schedule ? (
            ...
            <div className="md:col-span-4">
              ...
              <p className="text-sm text-muted-foreground">
                Please bring this information with you when you visit the office
                for your interview.
              </p>
              <div className="flex flex-col mt-5 space-y-2">
                <div className="flex md:flex-row flex-col md:items-center gap-3">
                  <User size={18} />
                  <p>
                    {applicant?.jobApplicant.name} - {applicant?.accountNumber}
                  </p>
                </div>
                <div className="flex md:flex-row flex-col md:items-center gap-3">
                ...
                <div className="flex md:flex-row flex-col md:items-start gap-3">
                  ...
                  <p className="md:w-[700px] w-full">
                    ...
                    interview, and your performance will be evaluated by the HR
                    Admin. We will notify you if you are accepted for the job.
                  </p>
                </div>
              </div>
            </div>
			...
			<p className="text-center text-red-600">No interview schedule found.</p>
		  )}
        </CardContent>
      </Card>
    </div>
